...
static void met_ptpod_polling(unsigned long long stamp, int cpu)
{
	if (mt_cpufreq_get_cur_volt_symbol) {
		...
		g_u4CPUVolt_B = mt_cpufreq_get_cur_volt_symbol(MT_CPU_DVFS_B)/100;
 ...
 */
static char header[] =
	"met-info [000] 0.0: ms_ud_sys_header: ptpod,CPUVolt_L,CPUVolt_B,CPUVolt_CCI,GPUVolt,d,d,d,d\n";
